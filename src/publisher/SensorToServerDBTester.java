...
public class SensorToServerDBTester  {
    ...
    SensorDataSolution oneSensor = 
    		new SensorDataSolution("SensorTest", "16062790", "mmuphidget_britt");
    ...
    public static String sensorServerURL = "http://localhost:8081/IOT_Web_Server/SensorServerDBSolution";
